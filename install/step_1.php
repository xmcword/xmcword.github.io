...
<div class="main">
  ...
  <div class="content-box">
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="0">
      <caption>
      函数检查<br><font color="red">【使用邮件发卡额外需支持】<br>sockets 当前状态:<?php echo extension_loaded('sockets') ? '支持' : '不支持'; ?><br>openssl 当前状态:<?php echo extension_loaded('openssl') ? '支持' : '不支持'; ?></font>
      </caption>
      <tr>
